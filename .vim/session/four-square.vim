...
let s:cpo_save=&cpo
set cpo&vim
inoremap <silent> <SNR>92_yrrecord =YRRecord3()
...
nnoremap <silent>  :YRReplace '-1', P
nnoremap  :browse confirm  saveas
nnoremap b =b:call MaxCurrentWindow():let g:tagbar_left = 0
nnoremap t =tl:call MaxCurrentWindow():let g:tagbar_left = 0
nnoremap z =bh:call MaxCurrentWindow():let g:tagbar_left = 1
nnoremap q =t:call MaxCurrentWindow():let g:tagbar_left = 1
nnoremap x -
nnoremap \ |
nnoremap _ -
nnoremap - _
nnoremap e =
nnoremap a :call MaxCurrentWindow()
nnoremap k k:call MaxCurrentWindow()
nnoremap j j:call MaxCurrentWindow()
nnoremap l l:call MaxCurrentWindow()
nnoremap h h:call MaxCurrentWindow()
nnoremap  :call ShowBufName()
nnoremap   ok
noremap 'b L
noremap 't H
...
vnoremap ,b 5
vnoremap ,f 5
nnoremap ,id :.-1 read !date -uJ
nnoremap ,ld :.   read !date kJ
nnoremap ,ss :%s ///g<Left><Left><Left>
nnoremap ,wc :%s///gn
nnoremap ,wn :%s///gn
nnoremap ,cv :set  cursorcolumn!  cursorcolumn?
nnoremap ,ch :set  cursorline!    cursorline?
nnoremap ,ls :set  list!  list?
nmap ,sg :cs find g =expand("<cword>")
nnoremap ,,P "+P
nnoremap ,,p "+p
nnoremap ,lp :echo  expand("%:p")
nnoremap ,ly yyI//
nnoremap ,lc I//
nnoremap ,lY yyI/* A */
nnoremap ,lC I/* A */
...
nnoremap ,a  a h
nnoremap ,i  i l
nnoremap ,l{ $a {  }<Left><Left>
nnoremap ,i{ o{}<Up>
nnoremap ,gO O
nnoremap ,go o
nnoremap ,lO Oj
nnoremap ,lo ok
nnoremap ,lx A<BS>:write
nnoremap ,l\ A \
nnoremap ,l! A!:write
nnoremap ,l. A.:write
nnoremap ,l, A,:write
nnoremap ,l; A;:write
nnoremap ,i; ][a;:write
nnoremap ,sb :FufBuffer
nnoremap ,sf :FufFile
nnoremap ,sp :CtrlP
nnoremap ,ct :!ctags -R --fields=+lS .:!cscope  -Rbq
nnoremap ,xw :%s/\s\+$//g:let @/=''
nnoremap ,sa a<Up>g_
nnoremap ,si i<Up>g_
nnoremap ,f 5
...
noremap ,er :e =expand("%:r")."."
nnoremap ,eI :e  $CRANE_DOT_VIM/vim-scripts/good-idea-script.vim
nnoremap ,ed :e  $CRANE_DOT_VIM/doc/
nnoremap ,eE :e  $CRANE_DOT_VIM/vim-scripts/example/
nnoremap ,ee :e!
nnoremap ,ef :e  $CRANE_DOT_VIM/vim-scripts/autocmd.vim
nnoremap ,ep :e  $CRANE_DOT_VIM/vim-scripts/myBundle.vim
nnoremap ,eT :e  $CRANE_DOT_VIM/vim-scripts/tmp-test.vim
nnoremap ,et :e  $CRANE_DOT_VIM/test/HarryPotter-Stone.txt
nnoremap ,ea :e  $CRANE_DOT_VIM/vim-scripts/abbrev-map.vim
nnoremap ,ec :e  $CRANE_DOT_VIM/vim-scripts/command-map.vim
nnoremap ,ei :e  $CRANE_DOT_VIM/vim-scripts/insert-map.vim
nnoremap ,en :e  $CRANE_DOT_VIM/vim-scripts/normal-map.vim
nnoremap ,eV :e  $CRANE_DOT_VIM/vim-scripts/visual-map.vim
nnoremap ,eg :e  $CRANE_VIM_HOME/.gvimrc
nnoremap ,ev :e  $CRANE_VIM_HOME/.vimrc
nnoremap ,elg :e $MYGVIMRC
nnoremap ,elv :e $MYVIMRC
nnoremap ,eq :e ./question-thunder.txt
nnoremap ,em :e ./makefile
nnoremap ,eA :e ~/myAlias.sh
nnoremap ,eG :e ~/.gitconfig
nnoremap ,eb :e ~/.bashrc
nnoremap ,i :set ignorecase!  ignorecase?
nnoremap ,/ :set hlsearch!    hlsearch?
nnoremap ,o :set nu!  rnu!    nu? rnu? 
nnoremap , 
...
nnoremap ,gd :Gdiff
nnoremap ,gs :Gstatus
nnoremap ,ti :TagbarToggle
map ,,. <Plug>(easymotion-repeat)
map ,,l <Plug>(easymotion-lineforward)
map ,,k <Plug>(easymotion-k)
map ,,j <Plug>(easymotion-j)
map ,,h <Plug>(easymotion-linebackward)
nnoremap ,bb :BufExplorerVerticalSplit
noremap ,ba :ConqueTermVSplit bash
nnoremap ,mw :WMToggle  "定义打开关闭winmanager快捷键为F8
nnoremap ,yd :YcmCompleter GoToDefinitionElseDeclaration " 跳转到定义处
nnoremap ,xn :NERDTreeToggle
nnoremap - ddp
vnoremap ; :
nnoremap ; :
nnoremap <a] <a{
...
smap ]u :call PythonUncommentSelection()
...
nnoremap <silent> g :call multiple_cursors#new("n", 1)
xnoremap <silent> gi :call multiple_cursors#new("v", 0)
nnoremap <silent> gi :call multiple_cursors#new("n", 0)
...
nmap <SNR>135_WE <Plug>AlignMapsWrapperEnd
map <SNR>135_WS <Plug>AlignMapsWrapperStart
...
nnoremap <silent> <SNR>92_yrrecord :call YRRecord3()
...
nnoremap <silent> <C-F5> :if  &guioptions =~#  'T' |set guioptions-=T|set guioptions-=m|else |set guioptions+=T |set guioptions+=m |endif
nnoremap <Down> gj
nnoremap <Up> gk
nnoremap <S-Tab> gT
nnoremap <F2> :UndotreeToggle
nnoremap <F4> :ToggleBufExplorer
nnoremap <F3> :ToggleBufExplorer:ToggleBufExplorer
...
inoremap ,, 
cnoremap ; !
inoremap chd> #include ""i
inoremap chd< #include <>i
inoremap jw :wa
inoremap jk 
iabbr jft just for test
iabbr @@ 215379@qq.com
iabbr q@ @qq.com
cnoreabbr csm :colorscheme  molokai
cnoreabbr ss :%s///g<Left><Left><Left>
cnoreabbr co cclose
cnoreabbr cle !clear
cnoreabbr clr !clear
cnoreabbr cd4 cd ../../../../
...
cnoreabbr cd2p cd ../../
cnoreabbr cdp cd ../
cnoreabbr cdS cd ~/Share
cnoreabbr cdd cd ~/Downloads
cnoreabbr cd- cd -
cnoreabbr cdh cd ~
cnoreabbr cdr cd /
cnoreabbr cds cd source
cnoreabbr cdb cd build
cnoreabbr cdt cd test
cnoreabbr cdv cd ~/.vim
cabbr mkab make all -B
cabbr mka make all
cabbr mkb make -B
cabbr mk make
cabbr lp :echo  expand("%:p")
cnoreabbr man Man
cabbr ll ls!
cabbr qq q!
cabbr bc BundleClear
cabbr BC BundleClear
cabbr BL BundleList
cabbr bi BundleInstall
cabbr BI BundleInstall
cabbr vbs :call Set_verbose()
let &cpo=s:cpo_save
unlet s:cpo_save
set autoread
set autowrite
...
silent only
cd /mySaved/vimrcBackup/.vim/session
...
exe '2resize ' . ((&lines * 14 + 17) / 34)
exe 'vert 2resize ' . ((&columns * 65 + 65) / 131)
exe '3resize ' . ((&lines * 10 + 17) / 34)
exe 'vert 3resize ' . ((&columns * 65 + 65) / 131)
exe '4resize ' . ((&lines * 9 + 17) / 34)
exe 'vert 4resize ' . ((&columns * 65 + 65) / 131)
exe '5resize ' . ((&lines * 9 + 17) / 34)
exe 'vert 5resize ' . ((&columns * 65 + 65) / 131)
argglobal
enew
let s:cpo_save=&cpo
set cpo&vim
